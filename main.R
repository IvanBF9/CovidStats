...
sex_plot <- ggplot() +
  ...
  labs(title = "Difference couverture vaccinale Homme Femme", x = "Classes d'âge", y = "Couverture vaccinale")
...
year_plot <- ggplot() +
  ...
  labs(title = "Couverture vaccinale 2021 / 2022", x = "Classes d'âge", y = "Couverture vaccinale")
